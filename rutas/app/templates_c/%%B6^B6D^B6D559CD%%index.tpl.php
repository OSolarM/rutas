<?php /* Smarty version 2.6.31, created on 2020-06-27 17:20:29
         compiled from ordenes_carabineros/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'select', 'ordenes_carabineros/index.tpl', 8, false),array('block', 'glink', 'ordenes_carabineros/index.tpl', 9, false),array('block', 't', 'ordenes_carabineros/index.tpl', 15, false),array('function', 'input', 'ordenes_carabineros/index.tpl', 33, false),array('function', 'submit', 'ordenes_carabineros/index.tpl', 38, false),)), $this); ?>
...
?>
<tr style="background:white;">
    <!--<td bgcolor=white><?php echo $this->_tpl_vars['rec']['id']; ?>
</td>-->
    <td align="right"><?php echo $this->_tpl_vars['rec']['id']; ?>
</td>
    <td><?php echo $this->_tpl_vars['rec']['orna_fecha']; ?>
</td>
    <td align="right"><?php echo $this->_tpl_vars['rec']['orna_m3']; ?>
</td>
    <td><?php echo $this->_tpl_vars['rec']['grad_descripcion']; ?>
</td>
    <td><?php echo $this->_tpl_vars['rec']['orna_apellidos']; ?>
</td>
    <td><?php echo $this->_tpl_vars['rec']['orna_nombres']; ?>
</td>
    <td><?php echo $this->_tpl_vars['rec']['orna_rut']; ?>
</td>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_glink($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
       <?php $this->_tag_stack[] = array('glink', array('img' => "delete.gif",'caption' => 'Elimina','confirm' => "?Seguro elimina registro?",'action' => 'delete')); $_block_repeat=true;smarty_block_glink($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>/<?php echo $this->_tpl_vars['rec']['id']; ?>
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_glink($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
