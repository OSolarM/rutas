...
<p>Datos b&aacute;sicos de las expediciones</p>
   ...
   {if $expe_tipo eq "I"}
   <table style="border:1px solid black;background:lightgray;" cellspacing="2px" cellpadding="6px">
   <tr>
         <td align="center" bgcolor="#aabbcc">{lbl}&nbsp;{/lbl}</td>
         <td align="center" bgcolor="#aabbcc">{lbl}Fec/Carga{/lbl}</td>
         <td align="center" bgcolor="#aabbcc">{lbl}Fec/LLeg/Aduana{/lbl}</td>
         <td align="center" bgcolor="#aabbcc">{lbl}Fec/Lib/Aduana{/lbl}</td>
         <td align="center" bgcolor="#aabbcc">{lbl}Fec/Descarga{/lbl}</td>         
         <td align="center" bgcolor="#aabbcc">{lbl}&nbsp;{/lbl}</td>         
   </tr>

   <tr>
         <td bgcolor="white">{lbl}EXPORTACI&Oacute;N{/lbl}</td>
         <td bgcolor="white">{input name="rend_fec_carga"   size="10" }</td>
         <td bgcolor="white">{input name="rend_fec_aduana"   size="10" }</td>
         <td bgcolor="white">{input name="rend_fec_bodega"   size="10" }</td>
         <td bgcolor="white">{input name="rend_fec_descarga" size="10" }</td>
         <td bgcolor="white">&nbsp;</td>
   </tr>
   <tr>
         <td bgcolor="white">{lbl}&nbsp;{/lbl}</td>
         <td align="center" bgcolor="#aabbcc">{lbl}Fec/Carga{/lbl}</td>
         <td align="center" bgcolor="#aabbcc">{lbl}Fec/LLeg/Aduana{/lbl}</td>
         <td align="center" bgcolor="#aabbcc">{lbl}Fec/Lib/Aduana{/lbl}</td>
         <td align="center" bgcolor="#aabbcc">{lbl}Fec/Descarga{/lbl}</td>         
         <td align="center" bgcolor="#aabbcc">{lbl}Bodega{/lbl}</td>  
   </tr>

   <tr>
         <td bgcolor="white">{lbl}IMPORTACI&Oacute;N{/lbl}</td>
         <td bgcolor="white">{input name="rend_fec_carga_imp"   size="10" }</td>
         <td bgcolor="white">{input name="rend_fec_aduana_imp"   size="10" }</td>
         <td bgcolor="white">{input name="rend_fec_bodega_imp"   size="10" }</td>
         <td bgcolor="white">{input name="rend_fec_descarga_imp" size="10" }</td>
         <td bgcolor="white">{select name="rend_bodega"}|,S&iacute;|S,No|N{/select}</td
...
<br/>
   ...
   {if $id_moneda2 ne ""}
   <table style="border:1px solid black">
   <tr>  <td align="center" bgcolor="#aabbcc" colspan="4">{lbl}{$moneda2}{/lbl}</td> 
   </tr>
   <tr>  <td align="center" bgcolor="#aabbcc">{lbl}Item de Gasto{/lbl}</td> 
         <td align="center" bgcolor="#aabbcc">{lbl}Monto{/lbl}</td>
         <td align="center" bgcolor="#aabbcc">{lbl}Litros{/lbl}</td>
         <td align="center" bgcolor="#aabbcc">{lbl}Fecha{/lbl}</td>
   </tr>

   <tr><td                            bgcolor="white">LITROS IDA MENDOZA</td>
       <td align="right"              bgcolor="white">&nbsp;</td>
       <td align="right"              bgcolor="white">{input name="rend_litros_ida_mendoza" size="6" style="text-align:right"}</td><td>{input name="rend_fec_ida_mendoza" size="10"}</td>
   </tr>

   <tr><td                            bgcolor="white">LITROS REGRESO MENDOZA</td>
       <td align="right"              bgcolor="white">&nbsp;</td>
       <td align="right"              bgcolor="white">{input name="rend_litros_regreso_mendoza" size="6" style="text-align:right"}</td><td>{input name="rend_fec_regreso_mendoza" size="10"}</td>
   </tr>
