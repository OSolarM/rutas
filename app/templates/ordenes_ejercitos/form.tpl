...
<tr>
    ...
    <td align="center">{lbl}Neto{/lbl}</td>
...
<tr>
    ...
    <td align="center">{select name="orna_cant_ordenes"}|,1|1,2|2{/select}</td>
    ...
    <td>{input name="orna_valor_guia" size="12" style="text-align:right"}</td>
...
<tr><td>{input name="orna_m3"      size="5"}</td>
