...
{$Form->create("Fondo")}
<h1>Asignaci&oacute;n Fondos Expediciones Internacionales</h1>
...
<table>
   ...
   <tr><td align="right">{lbl}Moneda Nacional{/lbl}    </td><td>{input name="fond_monto" size="11" style="text-align:right"}</td></tr>
   <tr><td align="right">{lbl}Moneda Extranjera 1{/lbl}    </td><td>{input name="fond_monto2" size="11" style="text-align:right"}{select name="id_moneda2"}{$lmonedas}{/select}</td></tr>
   <tr><td align="right">{lbl}Moneda Extranjera 2{/lbl}    </td><td>{input name="fond_monto3" size="11" style="text-align:right"}{select name="id_moneda3"}{$lmonedas}{/select}</td></tr>
