...
<tr bgcolor=#aabbcc>
    ...
    <td align=center><strong>{t}2da Moneda{/t}</strong></td> 
    <td align=center><strong>{t}3ra Moneda{/t}</strong></td> 
...
<tr>
    ...
    <td bgcolor=white align="right">{$rec.mone_cod}&nbsp;{$rec.fond_monto2|number_format:0:",":"."}</td>
    <td bgcolor=white align="right">{$rec.mone_cod_a}&nbsp;{$rec.fond_monto3|number_format:0:",":"."}</td> 
