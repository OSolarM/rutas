<?php /* Smarty version 2.6.31, created on 2020-06-27 17:20:01
         compiled from ordenes_ejercitos/form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'lbl', 'ordenes_ejercitos/form.tpl', 8, false),array('block', 'select', 'ordenes_ejercitos/form.tpl', 21, false),array('block', 'glink', 'ordenes_ejercitos/form.tpl', 162, false),array('function', 'input', 'ordenes_ejercitos/form.tpl', 19, false),array('function', 'hidden', 'ordenes_ejercitos/form.tpl', 29, false),array('function', 'area', 'ordenes_ejercitos/form.tpl', 157, false),)), $this); ?>
<?php echo $this->_tpl_vars['Form']->create('OrdenNacional'); ?>

<div id="stylized" class="myform" style="width:686px;">
<h1>Ej&eacute;rcito de Chile</h1>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_select($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>-->
    <td align="center"><?php $this->_tag_stack[] = array('select', array('name' => 'orna_cant_ordenes')); $_block_repeat=true;smarty_block_select($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>|,1|1,2|2<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_select($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
    ...
    <td><?php echo smarty_function_input(array('name' => 'orna_valor_guia','size' => '12','style' => "text-align:right"), $this);?>
</td>
...
<table>
<tr>
    <td align="center"><?php $this->_tag_stack[] = array('lbl', array()); $_block_repeat=true;smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Orden de Flete 1<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
    <td align="center"><?php $this->_tag_stack[] = array('lbl', array()); $_block_repeat=true;smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Orden de Compra 1<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
    <td align="center"><?php $this->_tag_stack[] = array('lbl', array()); $_block_repeat=true;smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Orden de Flete 2<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>    
    <td align="center"><?php $this->_tag_stack[] = array('lbl', array()); $_block_repeat=true;smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Orden de Compra 2<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
</tr>
<tr>
    <td><?php echo smarty_function_input(array('name' => 'orna_orden_flete1','size' => '20'), $this);?>
</td>
    <td><?php echo smarty_function_input(array('name' => 'orna_orden_compra','size' => '20'), $this);?>
</td>
    <td><?php echo smarty_function_input(array('name' => 'orna_orden_flete2','size' => '20'), $this);?>
</td>
    <td><?php echo smarty_function_input(array('name' => 'orna_orden_compra2','size' => '20'), $this);?>
</td>
</tr>
</table>
...
<tr><td><?php echo smarty_function_input(array('name' => 'orna_m3','size' => '5'), $this);?>
</td>
...
<tr>
   ...
   <td align="center"><?php $this->_tag_stack[] = array('lbl', array()); $_block_repeat=true;smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Orden Flete Auto<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
   <td align="center"><?php $this->_tag_stack[] = array('lbl', array()); $_block_repeat=true;smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Orden Compra Auto<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_lbl($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
</tr>
<tr>
   ...
   <td><?php echo smarty_function_input(array('name' => 'orna_orden_flete_auto','size' => '25'), $this);?>
</td>
   <td><?php echo smarty_function_input(array('name' => 'orna_orden_compra_auto','size' => '25'), $this);?>
</td>
</tr>
</table>
